...
def post_publish():
    ...
    try:
        prometheus_metrics.METRICS['posts'].labels(str(os.getpid())).inc()
        ...
        prometheus_metrics.METRICS['post_successes'].labels(str(os.getpid())).inc()
        ...
        ROOT_LOGGER.exception("Exception: %s", error_msg)
        prometheus_metrics.METRICS['post_errors'].labels(str(os.getpid())).inc()
